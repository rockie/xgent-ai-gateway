...
Use template from `/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
