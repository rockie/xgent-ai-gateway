...
5. Commit:
   ```bash
   node "/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
