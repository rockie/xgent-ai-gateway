...
```bash
PHASE_INFO=$(node "/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
