...
- **Global scope**: `/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/notes/`)
...
2. Glob `/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/rockie/Documents/GitHub/xgent/xgent-ai-gateway/.claude/notes/` — works in any directory
