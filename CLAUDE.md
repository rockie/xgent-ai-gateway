...
**Core Value:** Tasks submitted by clients reliably reach internal nodes and results reliably flow back, regardless of network topology — nodes behind NAT can serve work without inbound connectivity.
